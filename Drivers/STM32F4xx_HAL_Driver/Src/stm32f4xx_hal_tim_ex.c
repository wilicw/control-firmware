 ...
 *           @arg TIM_TIM2_ETH_PTP:    TIM2 ITR1 is connected to PTP trigger
 * output (*)
 ...
 *           @arg TIM_TIM5_RTC:        TIM5 TI4 is connected to the RTC wakeup
 * interrupt
 ...
 *           @arg TIM_TIM11_SPDIFRX:  TIM11 TI1 is connected to
 * SPDIFRX_FRAME_SYNC  (*)
 *
