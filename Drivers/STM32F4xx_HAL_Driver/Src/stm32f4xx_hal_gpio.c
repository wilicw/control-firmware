/**
  ...
  ******************************************************************************
  ...
  input line can be independently configured to select the type (interrupt or
  event) and the corresponding trigger event (rising or falling or both). Each
 ...
 * STM32F429X device or x can be (A..I) to select the GPIO peripheral for
 ...
 * @param  GPIOx where x can be (A..F) to select the GPIO peripheral for STM32F4
 * family
