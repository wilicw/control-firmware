...
HAL_StatusTypeDef HAL_RCCEx_PeriphCLKConfig(
  ...
  /* PLLI2S is configured when a peripheral will use it as source clock : SAI1,
     SAI2, I2S on APB1, I2S on APB2 or SPDIFRX */
  if ((plli2sused == 1U) ||
    ...
    if (((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_I2S_APB1) ==
      ...
      /* Read PLLI2SP/PLLI2SQ value from PLLI2SCFGR register (this value is not
       * needed for I2S configuration) */
    ...
    if (((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI1) ==
      ...
      /* Read PLLI2SP/PLLI2SR value from PLLI2SCFGR register (this value is not
    ...
    if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SPDIFRX) ==
      ...
      /* Read PLLI2SR value from PLLI2SCFGR register (this value is not need for
       * SAI configuration) */
  ...
  /* PLLSAI is configured when a peripheral will use it as source clock : SAI1,
   * SAI2, CLK48 or SDIO */
  if (pllsaiused == 1U) {
    ...
    if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_CLK48) ==
      ...
      /* Read PLLSAIQ value from PLLI2SCFGR register (this value is not need for
       * SAI configuration) */
    ...
    case RCC_PERIPHCLK_SAI2: {
      ...
      switch (saiclocksource) {
        case 0U: /* PLLSAI is the clock source for SAI*/
        {
          ...
          frequency =
              (vcoinput * ((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIN) >> 6U)) /
              (tmpreg1);
    ...
    case RCC_PERIPHCLK_I2S_APB1: {
      ...
      switch (srcclk) {
        ...
        case RCC_I2SAPB1CLKSOURCE_PLLR: {
          ...
          /* PLL_VCO Output = PLL_VCO Input * PLLN */
          vcooutput =
              (uint32_t)(vcoinput * (((RCC->PLLCFGR & RCC_PLLCFGR_PLLN) >> 6U) &
                                     (RCC_PLLCFGR_PLLN >> 6U)));
  ...
  if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI_PLLSAI) ==
    ...
    if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI_PLLSAI) ==
      ...
      pllsaip = ((((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIP) >>
                  ...
                  1U)
                 << 1U);
      /* Read PLLSAIR value from PLLSAICFGR register (this value is not need for
       * SAI configuration) */
    ...
    if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_LTDC) ==
      ...
      pllsaip = ((((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIP) >>
                  ...
                  1U)
                 << 1U);
      /* Read PLLSAIQ value from PLLSAICFGR register (this value is not need for
       * SAI configuration) */
      pllsaiq = ((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIQ) >>
                 RCC_PLLSAICFGR_PLLSAIQ_Pos);
      /* PLLSAI_VCO Input  = PLL_SOURCE/PLLM */
    ...
    if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_CLK48) ==
      ...
      __HAL_RCC_PLLSAI_CONFIG(PeriphClkInit->PLLSAI.PLLSAIN,
                              PeriphClkInit->PLLSAI.PLLSAIP, pllsaiq, pllsair);
    }
...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit) {
  ...
  /* Set all possible values for the extended clock type parameter------------*/
  PeriphClkInit->PeriphClockSelection =
      RCC_PERIPHCLK_I2S | RCC_PERIPHCLK_SAI_PLLSAI | RCC_PERIPHCLK_SAI_PLLI2S |
...
HAL_StatusTypeDef HAL_RCCEx_PeriphCLKConfig(
  ...
  /*-------------------------------------- PLLI2S Configuration --------------*/
  /* PLLI2S is configured when a peripheral will use it as source clock : I2S on
     APB1 or I2S on APB2*/
  if ((plli2sused == 1U) ||
      (PeriphClkInit->PeriphClockSelection == RCC_PERIPHCLK_PLLI2S)) {
    /* Disable the PLLI2S */
    ...
    if (((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAIA) ==
      ...
      /* Read PLLI2SQ value from PLLI2SCFGR register (this value is not needed
       * for SAI configuration) */
      plli2sq = ((RCC->PLLI2SCFGR & RCC_PLLI2SCFGR_PLLI2SQ) >>
                 RCC_PLLI2SCFGR_PLLI2SQ_Pos);
      /* Configure the PLLI2S division factors */
  ...
  if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_DFSDM2_AUDIO) ==
    ...
    /* Check the parameters */
    assert_param(
        IS_RCC_DFSDM2AUDIOCLKSOURCE(PeriphClkInit->Dfsdm2AudioClockSelection));
...
uint32_t HAL_RCC_GetSysClockFreq(void) {
  ...
  switch (RCC->CFGR & RCC_CFGR_SWS) {
    ...
    case RCC_CFGR_SWS_PLL: /* PLL/PLLP used as system clock  source */
    {
      ...
      pllp =
          ((((RCC->PLLCFGR & RCC_PLLCFGR_PLLP) >> RCC_PLLCFGR_PLLP_Pos) + 1U) *
           2U);
