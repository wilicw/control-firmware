/**
  ...
  *
  ...
  The DMA Extension HAL driver can be used as follows:
   (#) Start a multi buffer transfer using the HAL_DMA_MultiBufferStart()
  ...
  address for the AHB memory port on the fly (DMA_SxM0AR or DMA_SxM1AR) when the
  stream is enabled.
 ...
 * @param  SecondMemAddress The second memory Buffer address in case of multi
 * buffer Transfer
