...
#define HAL_SD_CARD_READY \
  0x00000001U /*!< Card state is ready                     */
#define HAL_SD_CARD_IDENTIFICATION \
  0x00000002U /*!< Card is in identification state         */
...
#define HAL_SD_CARD_ERROR \
  0x000000FFU /*!< Card response Error                     */
/**
 * @}
 */
...
typedef struct {
  ...
  __IO uint32_t ProtectedAreaSize; /*!< Carries information about the capacity
                                      of protected area   */
  __IO uint8_t
      SpeedClass; /*!< Carries information about the speed class of the card */
  ...
  __IO uint16_t EraseSize; /*!< Determines the number of AUs to be erased in one
                              operation */
  __IO uint8_t
      EraseTimeout; /*!< Determines the timeout for any number of AU erase */
...
/** @defgroup SD_Exported_Constansts_Group1 SD Error status enumeration
...
#define SD_CONTEXT_READ_SINGLE_BLOCK \
  0x00000001U /*!< Read single block operation      */
#define SD_CONTEXT_READ_MULTIPLE_BLOCK \
  0x00000002U /*!< Read multiple blocks operation   */
#define SD_CONTEXT_WRITE_SINGLE_BLOCK \
  0x00000010U /*!< Write single block operation     */
#define SD_CONTEXT_WRITE_MULTIPLE_BLOCK \
  0x00000020U                      /*!< Write multiple blocks operation  */
 ...
 */
#define CARD_SDSC \
  0x00000000U /*!< SD Standard Capacity <2Go                          */
#define CARD_SDHC_SDXC \
  0x00000001U /*!< SD High Capacity <32Go, SD Extended Capacity <2To  */
...
/** @defgroup SD_Exported_Functions_Group1 Initialization and de-initialization
 * functions
 * @{
 */
