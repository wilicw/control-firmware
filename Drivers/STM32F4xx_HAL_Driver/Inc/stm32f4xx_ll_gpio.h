 ...
 */
    ...
    defined(GPIOI) || defined(GPIOJ) || defined(GPIOK)
...
#define LL_GPIO_SPEED_FREQ_MEDIUM \
  GPIO_OSPEEDER_OSPEEDR0_0 /*!< Select I/O medium output speed */
#define LL_GPIO_SPEED_FREQ_HIGH \
  GPIO_OSPEEDER_OSPEEDR0_1 /*!< Select I/O fast output speed   */
#define LL_GPIO_SPEED_FREQ_VERY_HIGH \
  GPIO_OSPEEDER_OSPEEDR0 /*!< Select I/O high output speed   */
/**
 * @}
 */
...
__STATIC_INLINE uint32_t LL_GPIO_GetPinSpeed(GPIO_TypeDef *GPIOx,
                                             uint32_t Pin) {
  return (uint32_t)(READ_BIT(GPIOx->OSPEEDR, (GPIO_OSPEEDER_OSPEEDR0
                                              << (POSITION_VAL(Pin) * 2U))) >>
                    (POSITION_VAL(Pin) * 2U));
}
 ...
 */
          ...
          defined (GPIOH) || defined (GPIOI) || defined (GPIOJ) || defined    \
          (GPIOK) */
/**
 * @}
 */
