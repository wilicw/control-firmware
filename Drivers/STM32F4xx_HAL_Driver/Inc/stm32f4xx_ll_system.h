...
#define LL_SYSCFG_BANKMODE_BANK2                                              \
  SYSCFG_MEMRMP_UFB_MODE /*!< Flash Bank 2 base address mapped at 0x0800 0000 \
                          (AXI) and 0x0020 0000(TCM) and Flash Bank 1 base                                                        \
                          address mapped at 0x0810 0000 (AXI) and 0x0030      \
                          0000(TCM) */
/**
 * @}
 */
...
#define LL_SYSCFG_TIMBREAK_PVD                                                \
  SYSCFG_CFGR2_PVD_LOCK /*!< Enables and locks the PVD connection with TIM1/8 \
                        Break Input and also the PVDE and PLS bits of the                                        \
...
#define LL_DBGMCU_APB1_GRP1_WWDG_STOP                                          \
  DBGMCU_APB1_FZ_DBG_WWDG_STOP /*!< Debug Window Watchdog stopped when Core is \
                                  halted */
...
__STATIC_INLINE uint32_t LL_SYSCFG_GetTIMBreakInputs(void) {
  return (uint32_t)(READ_BIT(SYSCFG->CFGR2,
                             SYSCFG_CFGR2_LOCKUP_LOCK | SYSCFG_CFGR2_PVD_LOCK));
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_SYSCFG_DFSDM_SetBitstreamClockSourceSelection(
 ...
 * @retval None
 */
__STATIC_INLINE void LL_SYSCFG_DFSDM1_SetTIM4OC2BitStreamDistribution(
    uint32_t Source) {
 ...
 * @retval None
 */
__STATIC_INLINE void LL_SYSCFG_DFSDM1_SetTIM4OC1BitStreamDistribution(
    uint32_t Source) {
 ...
 * @retval None
 */
__STATIC_INLINE void LL_SYSCFG_DFSDM1_SetClockInSourceSelection(
    uint32_t ClockSource) {
 ...
 * @retval None
 */
__STATIC_INLINE void LL_SYSCFG_DFSDM1_SetClockOutSourceSelection(
    uint32_t ClockSource) {
 ...
 * @retval None
 */
__STATIC_INLINE void LL_SYSCFG_DFSDM2_SetTIM3OC4BitStreamDistribution(
    uint32_t Source) {
 ...
 * @retval None
 */
__STATIC_INLINE void LL_SYSCFG_DFSDM2_SetTIM3OC2BitStreamDistribution(
    uint32_t Source) {
 ...
 * @retval None
 */
__STATIC_INLINE void LL_SYSCFG_DFSDM2_SetTIM3OC1BitStreamDistribution(
    uint32_t Source) {
 ...
 * @retval None
 */
__STATIC_INLINE void LL_SYSCFG_DFSDM2_SetClockInSourceSelection(
    uint32_t ClockSource) {
 ...
 * @retval None
 */
__STATIC_INLINE void LL_SYSCFG_DFSDM2_SetClockOutSourceSelection(
    uint32_t ClockSource) {
