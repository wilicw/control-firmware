...
#define LL_TIM_TIM2_ITR1_RMP_TIM8_TRGO \
  TIM2_OR_RMP_MASK /*!< TIM2_ITR1 is connected to TIM8_TRGO */
#define LL_TIM_TIM2_ITR1_RMP_ETH_PTP \
  (TIM_OR_ITR1_RMP_0 |               \
   TIM2_OR_RMP_MASK) /*!< TIM2_ITR1 is connected to ETH_PTP */
#define LL_TIM_TIM2_ITR1_RMP_OTG_FS_SOF \
  (TIM_OR_ITR1_RMP_1 |                  \
   TIM2_OR_RMP_MASK) /*!< TIM2_ITR1 is connected to OTG_FS SOF */
#define LL_TIM_TIM2_ITR1_RMP_OTG_HS_SOF \
  (TIM_OR_ITR1_RMP |                    \
   TIM2_OR_RMP_MASK) /*!< TIM2_ITR1 is connected to OTG_HS SOF */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_TIM_TIM5_TI4_RMP_GPIO \
  TIM5_OR_RMP_MASK /*!< TIM5 channel 4 is connected to GPIO */
#define LL_TIM_TIM5_TI4_RMP_LSI \
  (TIM_OR_TI4_RMP_0 |           \
   TIM5_OR_RMP_MASK) /*!< TIM5 channel 4 is connected to LSI internal clock */
#define LL_TIM_TIM5_TI4_RMP_LSE \
  (TIM_OR_TI4_RMP_1 |           \
   TIM5_OR_RMP_MASK) /*!< TIM5 channel 4 is connected to LSE */
#define LL_TIM_TIM5_TI4_RMP_RTC                                               \
  (TIM_OR_TI4_RMP | TIM5_OR_RMP_MASK) /*!< TIM5 channel 4 is connected to RTC \
                                         wakeup interrupt */
/**
 * @}
 */
...
#define LL_TIM_TIM11_TI1_RMP_GPIO \
  TIM11_OR_RMP_MASK /*!< TIM11 channel 1 is connected to GPIO */
#if defined(SPDIFRX)
#define LL_TIM_TIM11_TI1_RMP_SPDIFRX \
  (TIM_OR_TI1_RMP_0 |                \
   TIM11_OR_RMP_MASK) /*!< TIM11 channel 1 is connected to SPDIFRX */

/* Legacy define */
#define LL_TIM_TIM11_TI1_RMP_GPIO1                    \
  LL_TIM_TIM11_TI1_RMP_SPDIFRX /*!< Legacy define for \
...
#define LL_TIM_TIM11_TI1_RMP_GPIO1 \
  (TIM_OR_TI1_RMP_0 |              \
   TIM11_OR_RMP_MASK) /*!< TIM11 channel 1 is connected to GPIO */
#endif                /* SPDIFRX */
#define LL_TIM_TIM11_TI1_RMP_GPIO2 \
  (TIM_OR_TI1_RMP |                \
   TIM11_OR_RMP_MASK) /*!< TIM11 channel 1 is connected to GPIO */
#define LL_TIM_TIM11_TI1_RMP_HSE_RTC \
  (TIM_OR_TI1_RMP_1 |                \
   TIM11_OR_RMP_MASK) /*!< TIM11 channel 1 is connected to HSE_RTC */
/**
 * @}
 */
#if defined(LPTIM_OR_TIM1_ITR2_RMP) && defined(LPTIM_OR_TIM5_ITR1_RMP) && \
    defined(LPTIM_OR_TIM9_ITR1_RMP)

#define LL_TIM_LPTIM_REMAP_MASK 0x10000000U

#define LL_TIM_TIM9_ITR1_RMP_TIM3_TRGO \
  LL_TIM_LPTIM_REMAP_MASK /*!< TIM9_ITR1 is connected to TIM3 TRGO */
#define LL_TIM_TIM9_ITR1_RMP_LPTIM \
  (LL_TIM_LPTIM_REMAP_MASK |       \
   LPTIM_OR_TIM9_ITR1_RMP) /*!< TIM9_ITR1 is connected to LPTIM1 output */

#define LL_TIM_TIM5_ITR1_RMP_TIM3_TRGO \
  LL_TIM_LPTIM_REMAP_MASK /*!< TIM5_ITR1 is connected to TIM3 TRGO */
#define LL_TIM_TIM5_ITR1_RMP_LPTIM \
  (LL_TIM_LPTIM_REMAP_MASK |       \
   LPTIM_OR_TIM5_ITR1_RMP) /*!< TIM5_ITR1 is connected to LPTIM1 output */

#define LL_TIM_TIM1_ITR2_RMP_TIM3_TRGO \
  LL_TIM_LPTIM_REMAP_MASK /*!< TIM1_ITR2 is connected to TIM3 TRGO */
#define LL_TIM_TIM1_ITR2_RMP_LPTIM \
  (LL_TIM_LPTIM_REMAP_MASK |       \
   LPTIM_OR_TIM1_ITR2_RMP) /*!< TIM1_ITR2 is connected to LPTIM1 output */

#endif /* LPTIM_OR_TIM1_ITR2_RMP &&  LPTIM_OR_TIM5_ITR1_RMP && \
...
__STATIC_INLINE void LL_TIM_SetRemap(TIM_TypeDef *TIMx, uint32_t Remap) {
  ...
  if ((Remap & LL_TIM_LPTIM_REMAP_MASK) == LL_TIM_LPTIM_REMAP_MASK) {
    ...
    MODIFY_REG(LPTIM1->OR,
               (LPTIM_OR_TIM1_ITR2_RMP | LPTIM_OR_TIM5_ITR1_RMP |
                LPTIM_OR_TIM9_ITR1_RMP),
...
#endif /* TIM1 || TIM2 || TIM3 || TIM4 || TIM5 || TIM6 || TIM7 || TIM8 || TIM9 \
