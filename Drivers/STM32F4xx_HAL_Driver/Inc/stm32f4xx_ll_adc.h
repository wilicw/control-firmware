...
#define ADC_REG_RANK_1_SQRX_BITOFFSET_POS \
  (0UL) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ1) */
#define ADC_REG_RANK_2_SQRX_BITOFFSET_POS \
  (5UL) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ2) */
#define ADC_REG_RANK_3_SQRX_BITOFFSET_POS \
  (10UL) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ3) */
#define ADC_REG_RANK_4_SQRX_BITOFFSET_POS \
  (15UL) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ4) */
#define ADC_REG_RANK_5_SQRX_BITOFFSET_POS \
  (20UL) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ5) */
#define ADC_REG_RANK_6_SQRX_BITOFFSET_POS \
  (25UL) /* Value equivalent to POSITION_VAL(ADC_SQR3_SQ6) */
#define ADC_REG_RANK_7_SQRX_BITOFFSET_POS \
  (0UL) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ7) */
#define ADC_REG_RANK_8_SQRX_BITOFFSET_POS \
  (5UL) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ8) */
#define ADC_REG_RANK_9_SQRX_BITOFFSET_POS \
  (10UL) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ9) */
#define ADC_REG_RANK_10_SQRX_BITOFFSET_POS \
  (15UL) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ10) */
#define ADC_REG_RANK_11_SQRX_BITOFFSET_POS \
  (20UL) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ11) */
#define ADC_REG_RANK_12_SQRX_BITOFFSET_POS \
  (25UL) /* Value equivalent to POSITION_VAL(ADC_SQR2_SQ12) */
#define ADC_REG_RANK_13_SQRX_BITOFFSET_POS \
  (0UL) /* Value equivalent to POSITION_VAL(ADC_SQR1_SQ13) */
#define ADC_REG_RANK_14_SQRX_BITOFFSET_POS \
  (5UL) /* Value equivalent to POSITION_VAL(ADC_SQR1_SQ14) */
#define ADC_REG_RANK_15_SQRX_BITOFFSET_POS \
  (10UL) /* Value equivalent to POSITION_VAL(ADC_SQR1_SQ15) */
#define ADC_REG_RANK_16_SQRX_BITOFFSET_POS \
  (15UL) /* Value equivalent to POSITION_VAL(ADC_SQR1_SQ16) */
...
#define ADC_REG_TRIG_EXT_EDGE_DEFAULT                                       \
  (ADC_CR2_EXTEN_0) /* Trigger edge set to rising edge (default setting for \
...
#define ADC_REG_TRIG_SOURCE_MASK                                           \
  (((LL_ADC_REG_TRIG_SOFTWARE & ADC_CR2_EXTSEL) >> (4UL * 0UL)) |          \
   ((ADC_CR2_EXTSEL) >> (4UL * 1UL)) | ((ADC_CR2_EXTSEL) >> (4UL * 2UL)) | \
...
#define ADC_REG_TRIG_EDGE_MASK                                   \
  (((LL_ADC_REG_TRIG_SOFTWARE & ADC_CR2_EXTEN) >> (4UL * 0UL)) | \
...
#define ADC_REG_TRIG_EXTSEL_BITOFFSET_POS \
  (24UL) /* Value equivalent to POSITION_VAL(ADC_CR2_EXTSEL) */
#define ADC_REG_TRIG_EXTEN_BITOFFSET_POS \
  (28UL) /* Value equivalent to POSITION_VAL(ADC_CR2_EXTEN) */
...
#define ADC_INJ_TRIG_EXT_EDGE_DEFAULT                                        \
  (ADC_CR2_JEXTEN_0) /* Trigger edge set to rising edge (default setting for \
                        compatibility with some ADC on other STM32 families  \
                        having this setting set by HW default value) */
...
#define ADC_INJ_TRIG_SOURCE_MASK                                             \
  (((LL_ADC_REG_TRIG_SOFTWARE & ADC_CR2_JEXTSEL) >> (4UL * 0UL)) |           \
   ((ADC_CR2_JEXTSEL) >> (4UL * 1UL)) | ((ADC_CR2_JEXTSEL) >> (4UL * 2UL)) | \
...
#define ADC_INJ_TRIG_EDGE_MASK                                    \
  (((LL_ADC_INJ_TRIG_SOFTWARE & ADC_CR2_JEXTEN) >> (4UL * 0UL)) | \
...
#define ADC_INJ_TRIG_EXTSEL_BITOFFSET_POS \
  (16UL) /* Value equivalent to POSITION_VAL(ADC_CR2_JEXTSEL) */
#define ADC_INJ_TRIG_EXTEN_BITOFFSET_POS \
  (20UL) /* Value equivalent to POSITION_VAL(ADC_CR2_JEXTEN) */
...
#define ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS \
  (0UL) /* Value equivalent to POSITION_VAL(ADC_CHANNEL_ID_NUMBER_MASK) */
...
#define ADC_CHANNEL_DIFFERENCIATION_TEMPSENSOR_VBAT                           \
  0x10000000U /* Dummy bit for driver internal usage, not used in ADC channel \
                 setting registers CR1 or SQRx */
...
#define ADC_CHANNEL_SMPx_BITOFFSET_POS                                        \
  (20UL) /* Value equivalent to POSITION_VAL(ADC_CHANNEL_SMPx_BITOFFSET_MASK) \
          */
...
#define ADC_CHANNEL_7_NUMBER \
  (ADC_CR1_AWDCH_2 | ADC_CR1_AWDCH_1 | ADC_CR1_AWDCH_0)
  ...
  (ADC_SMPR2_REGOFFSET |                                                  \
   ((0UL)                                                                 \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR2_SMP0) */
#define ADC_CHANNEL_1_SMP                                                 \
  (ADC_SMPR2_REGOFFSET |                                                  \
   ((3UL)                                                                 \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR2_SMP1) */
#define ADC_CHANNEL_2_SMP                                                 \
  (ADC_SMPR2_REGOFFSET |                                                  \
   ((6UL)                                                                 \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR2_SMP2) */
#define ADC_CHANNEL_3_SMP                                                 \
  (ADC_SMPR2_REGOFFSET |                                                  \
   ((9UL)                                                                 \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR2_SMP3) */
#define ADC_CHANNEL_4_SMP                                                 \
  (ADC_SMPR2_REGOFFSET |                                                  \
   ((12UL)                                                                \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR2_SMP4) */
#define ADC_CHANNEL_5_SMP                                                 \
  (ADC_SMPR2_REGOFFSET |                                                  \
   ((15UL)                                                                \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR2_SMP5) */
#define ADC_CHANNEL_6_SMP                                                 \
  (ADC_SMPR2_REGOFFSET |                                                  \
   ((18UL)                                                                \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR2_SMP6) */
#define ADC_CHANNEL_7_SMP                                                 \
  (ADC_SMPR2_REGOFFSET |                                                  \
   ((21UL)                                                                \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR2_SMP7) */
#define ADC_CHANNEL_8_SMP                                                 \
  (ADC_SMPR2_REGOFFSET |                                                  \
   ((24UL)                                                                \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR2_SMP8) */
#define ADC_CHANNEL_9_SMP                                                 \
  (ADC_SMPR2_REGOFFSET |                                                  \
   ((27UL)                                                                \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR2_SMP9) */
#define ADC_CHANNEL_10_SMP                                                \
  (ADC_SMPR1_REGOFFSET |                                                  \
   ((0UL)                                                                 \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR1_SMP10) */
#define ADC_CHANNEL_11_SMP                                                \
  (ADC_SMPR1_REGOFFSET |                                                  \
   ((3UL)                                                                 \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR1_SMP11) */
#define ADC_CHANNEL_12_SMP                                                \
  (ADC_SMPR1_REGOFFSET |                                                  \
   ((6UL)                                                                 \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR1_SMP12) */
#define ADC_CHANNEL_13_SMP                                                \
  (ADC_SMPR1_REGOFFSET |                                                  \
   ((9UL)                                                                 \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR1_SMP13) */
#define ADC_CHANNEL_14_SMP                                                \
  (ADC_SMPR1_REGOFFSET |                                                  \
   ((12UL)                                                                \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR1_SMP14) */
#define ADC_CHANNEL_15_SMP                                                \
  (ADC_SMPR1_REGOFFSET |                                                  \
   ((15UL)                                                                \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR1_SMP15) */
#define ADC_CHANNEL_16_SMP                                                \
  (ADC_SMPR1_REGOFFSET |                                                  \
   ((18UL)                                                                \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR1_SMP16) */
#define ADC_CHANNEL_17_SMP                                                \
  (ADC_SMPR1_REGOFFSET |                                                  \
   ((21UL)                                                                \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR1_SMP17) */
#define ADC_CHANNEL_18_SMP                                                \
  (ADC_SMPR1_REGOFFSET |                                                  \
   ((24UL)                                                                \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to \
                                           POSITION_VAL(ADC_SMPR1_SMP18) */
...
#define ADC_AWD_CR1_CHANNEL_MASK \
  (ADC_CR1_AWDCH | ADC_CR1_JAWDEN | ADC_CR1_AWDEN | ADC_CR1_AWDSGL)
...
#define ADC_CR1_RES_BITOFFSET_POS \
  (24UL) /* Value equivalent to POSITION_VAL(ADC_CR1_RES) */
#define ADC_TR_HT_BITOFFSET_POS \
  (16UL) /* Value equivalent to POSITION_VAL(ADC_TR_HT) */

/* ADC internal channels related definitions */
/* Internal voltage reference VrefInt */
#define VREFINT_CAL_ADDR                                                     \
  ((uint16_t                                                                 \
        *)(0x1FFF7A2AU)) /* Internal voltage reference, address of parameter \
...
#define VREFINT_CAL_VREF                                                    \
  (3300UL) /* Analog voltage reference (Vref+) value with which temperature \
              sensor has been calibrated in production (tolerance: +-10 mV) \
              (unit: mV). */
/* Temperature sensor */
#define TEMPSENSOR_CAL1_ADDR                                                  \
  ((uint16_t                                                                  \
        *)(0x1FFF7A2CU)) /* Internal temperature sensor, address of parameter \
                            TS_CAL1: On STM32F4, temperature sensor ADC raw   \
                            data acquired at temperature  30 DegC (tolerance: \
                            +-5 DegC), Vref+ = 3.3 V (tolerance: +-10 mV). */
#define TEMPSENSOR_CAL2_ADDR                                                  \
  ((uint16_t                                                                  \
        *)(0x1FFF7A2EU)) /* Internal temperature sensor, address of parameter \
                            TS_CAL2: On STM32F4, temperature sensor ADC raw   \
                            data acquired at temperature 110 DegC (tolerance: \
                            +-5 DegC), Vref+ = 3.3 V (tolerance: +-10 mV). */
#define TEMPSENSOR_CAL1_TEMP                                                   \
  ((int32_t)30) /* Internal temperature sensor, temperature at which           \
                   temperature sensor has been calibrated in production for    \
                   data into TEMPSENSOR_CAL1_ADDR (tolerance: +-5 DegC) (unit: \
                   DegC). */
#define TEMPSENSOR_CAL2_TEMP                                                 \
  ((int32_t)110) /* Internal temperature sensor, temperature at which        \
                    temperature sensor has been calibrated in production for \
                    data into TEMPSENSOR_CAL2_ADDR (tolerance: +-5 DegC)     \
                    (unit: DegC). */
#define TEMPSENSOR_CAL_VREFANALOG                                             \
  (3300UL) /* Analog voltage reference (Vref+) voltage with which temperature \
...
typedef struct {
  uint32_t CommonClock; /*!< Set parameter common to several ADC: Clock source
                           ...
                           unitary function @ref LL_ADC_SetCommonClock(). */
...
typedef struct {
  uint32_t
      TriggerSource; /*!< Set ADC group regular conversion trigger source:
                        ...
                        of @ref ADC_LL_EC_REG_TRIGGER_SOURCE
                          @note On this STM32 series, setting of external
                        trigger edge is performed using function @ref
  ...
  uint32_t SequencerLength; /*!< Set ADC group regular sequencer length.
                               ...
                               ADC_LL_EC_REG_SEQ_SCAN_LENGTH
                                 @note This parameter is discarded if scan mode
                               is disabled (refer to parameter
...
typedef struct {
  uint32_t
      TriggerSource; /*!< Set ADC group injected conversion trigger source:
                        internal (SW start) or from external IP (timer event,
                        external interrupt line). This parameter can be a value
                        of @ref ADC_LL_EC_INJ_TRIGGER_SOURCE
                          @note On this STM32 series, setting of external
                        trigger edge is performed using function @ref
...
#define LL_ADC_FLAG_STRT \
  ADC_SR_STRT /*!< ADC flag ADC group regular conversion start */
#define LL_ADC_FLAG_EOCS                                                      \
  ADC_SR_EOC /*!< ADC flag ADC group regular end of unitary conversion or     \
...
#define LL_ADC_FLAG_JSTRT \
  ADC_SR_JSTRT /*!< ADC flag ADC group injected conversion start */
#define LL_ADC_FLAG_JEOS                                                     \
  ADC_SR_JEOC /*!< ADC flag ADC group injected end of sequence conversions   \
                 (Note: on this STM32 series, there is no flag ADC group     \
                 injected end of unitary conversion. Flag noted as "JEOC" is \
...
#define LL_ADC_FLAG_EOCS_MST                                                   \
  ADC_CSR_EOC1 /*!< ADC flag ADC multimode master group regular end of unitary \
                  conversion or sequence conversions (to configure flag of end \
                  of conversion, use function @ref                             \
                  LL_ADC_REG_SetFlagEndOfConversion() ) */
#define LL_ADC_FLAG_EOCS_SLV1                                              \
  ADC_CSR_EOC2 /*!< ADC flag ADC multimode slave 1 group regular end of    \
                  unitary conversion or sequence conversions (to configure \
                  flag of end of conversion, use function @ref             \
                  LL_ADC_REG_SetFlagEndOfConversion() ) */
#define LL_ADC_FLAG_EOCS_SLV2                                              \
  ADC_CSR_EOC3 /*!< ADC flag ADC multimode slave 2 group regular end of    \
                  unitary conversion or sequence conversions (to configure \
                  flag of end of conversion, use function @ref             \
                  LL_ADC_REG_SetFlagEndOfConversion() ) */
#define LL_ADC_FLAG_OVR_MST \
  ADC_CSR_OVR1 /*!< ADC flag ADC multimode master group regular overrun */
#define LL_ADC_FLAG_OVR_SLV1 \
  ADC_CSR_OVR2 /*!< ADC flag ADC multimode slave 1 group regular overrun */
#define LL_ADC_FLAG_OVR_SLV2 \
  ADC_CSR_OVR3 /*!< ADC flag ADC multimode slave 2 group regular overrun */
#define LL_ADC_FLAG_JEOS_MST                                                  \
  ADC_CSR_JEOC1 /*!< ADC flag ADC multimode master group injected end of      \
                   sequence conversions (Note: on this STM32 series, there is \
                   no flag ADC group injected end of unitary conversion. Flag \
                   noted as "JEOC" is corresponding to flag "JEOS" in other   \
                   STM32 families) */
#define LL_ADC_FLAG_JEOS_SLV1                                                 \
  ADC_CSR_JEOC2 /*!< ADC flag ADC multimode slave 1 group injected end of     \
                   sequence conversions (Note: on this STM32 series, there is \
                   no flag ADC group injected end of unitary conversion. Flag \
                   noted as "JEOC" is corresponding to flag "JEOS" in other   \
                   STM32 families) */
#define LL_ADC_FLAG_JEOS_SLV2                                                 \
  ADC_CSR_JEOC3 /*!< ADC flag ADC multimode slave 2 group injected end of     \
                   sequence conversions (Note: on this STM32 series, there is \
                   no flag ADC group injected end of unitary conversion. Flag \
                   noted as "JEOC" is corresponding to flag "JEOS" in other   \
                   STM32 families) */
#define LL_ADC_FLAG_AWD1_MST                                                   \
  ADC_CSR_AWD1 /*!< ADC flag ADC multimode master analog watchdog 1 of the ADC \
                  master */
#define LL_ADC_FLAG_AWD1_SLV1 \
  ADC_CSR_AWD2 /*!< ADC flag ADC multimode slave 1 analog watchdog 1 */
#define LL_ADC_FLAG_AWD1_SLV2 \
  ADC_CSR_AWD3 /*!< ADC flag ADC multimode slave 2 analog watchdog 1 */
#endif
/**
 * @}
 */
...
#define LL_ADC_IT_EOCS                                                      \
  ADC_CR1_EOCIE /*!< ADC interruption ADC group regular end of unitary      \
                   conversion or sequence conversions (to configure flag of \
                   end of conversion, use function @ref                     \
                   LL_ADC_REG_SetFlagEndOfConversion() ) */
#define LL_ADC_IT_OVR \
  ADC_CR1_OVRIE /*!< ADC interruption ADC group regular overrun */
#define LL_ADC_IT_JEOS                                                        \
  ADC_CR1_JEOCIE /*!< ADC interruption ADC group injected end of sequence     \
                    conversions (Note: on this STM32 series, there is no flag \
                    ADC group injected end of unitary conversion. Flag noted  \
                    as "JEOC" is corresponding to flag "JEOS" in other STM32  \
                    families) */
#define LL_ADC_IT_AWD1 \
  ADC_CR1_AWDIE /*!< ADC interruption ADC analog watchdog 1 */
/**
 * @}
 */
...
#define LL_ADC_DMA_REG_REGULAR_DATA                                            \
  0x00000000UL /* ADC group regular conversion data register (corresponding to \
                  register DR) to be used with ADC configured in independent   \
                  mode. Without DMA transfer, register accessed by LL function \
                  @ref LL_ADC_REG_ReadConversionData32() and other functions   \
                  @ref LL_ADC_REG_ReadConversionDatax() */
#if defined(ADC_MULTIMODE_SUPPORT)
#define LL_ADC_DMA_REG_REGULAR_DATA_MULTI                                      \
  0x00000001UL /* ADC group regular conversion data register (corresponding to \
                  register CDR) to be used with ADC configured in multimode    \
...
#define LL_ADC_CLOCK_SYNC_PCLK_DIV2                                   \
  0x00000000UL /*!< ADC synchronous clock derived from AHB clock with \
                  prescaler division by 2 */
#define LL_ADC_CLOCK_SYNC_PCLK_DIV4                                         \
  (ADC_CCR_ADCPRE_0) /*!< ADC synchronous clock derived from AHB clock with \
                        prescaler division by 4 */
#define LL_ADC_CLOCK_SYNC_PCLK_DIV6                                         \
  (ADC_CCR_ADCPRE_1) /*!< ADC synchronous clock derived from AHB clock with \
...
#define LL_ADC_PATH_INTERNAL_VREFINT \
  (ADC_CCR_TSVREFE) /*!< ADC measurement path to internal channel VrefInt */
#define LL_ADC_PATH_INTERNAL_TEMPSENSOR                                       \
  (ADC_CCR_TSVREFE) /*!< ADC measurement path to internal channel temperature \
                       sensor */
#define LL_ADC_PATH_INTERNAL_VBAT \
  (ADC_CCR_VBATE) /*!< ADC measurement path to internal channel Vbat */
/**
 * @}
 */
...
#define LL_ADC_RESOLUTION_6B \
  (ADC_CR1_RES_1 | ADC_CR1_RES_0) /*!< ADC resolution  6 bits */
/**
 * @}
 */
...
#define LL_ADC_DATA_ALIGN_RIGHT                                                \
  0x00000000UL /*!< ADC conversion data alignment: right aligned (alignment on \
                  data register LSB bit 0)*/
#define LL_ADC_DATA_ALIGN_LEFT                                                \
  (ADC_CR2_ALIGN) /*!< ADC conversion data alignment: left aligned (alignment \
...
#define LL_ADC_SEQ_SCAN_DISABLE                                                \
  0x00000000UL /*!< ADC conversion is performed in unitary conversion mode     \
                  (one channel converted, that defined in rank 1).             \
                  Configuration of both groups regular and injected sequencers \
                  (sequence length, ...) is discarded: equivalent to length of \
                  1 rank.*/
#define LL_ADC_SEQ_SCAN_ENABLE                                              \
  (ADC_CR1_SCAN) /*!< ADC conversions are performed in sequence conversions \
                    mode, according to configuration of both groups regular \
                    and injected sequencers (sequence length, ...). */
/**
 * @}
 */
...
#define LL_ADC_CHANNEL_0                                                   \
  (ADC_CHANNEL_0_NUMBER |                                                  \
   ADC_CHANNEL_0_SMP) /*!< ADC external channel (channel connected to GPIO \
                         pin) ADCx_IN0  */
#define LL_ADC_CHANNEL_1                                                   \
  (ADC_CHANNEL_1_NUMBER |                                                  \
   ADC_CHANNEL_1_SMP) /*!< ADC external channel (channel connected to GPIO \
                         pin) ADCx_IN1  */
#define LL_ADC_CHANNEL_2                                                   \
  (ADC_CHANNEL_2_NUMBER |                                                  \
   ADC_CHANNEL_2_SMP) /*!< ADC external channel (channel connected to GPIO \
                         pin) ADCx_IN2  */
#define LL_ADC_CHANNEL_3                                                   \
  (ADC_CHANNEL_3_NUMBER |                                                  \
   ADC_CHANNEL_3_SMP) /*!< ADC external channel (channel connected to GPIO \
                         pin) ADCx_IN3  */
#define LL_ADC_CHANNEL_4                                                   \
  (ADC_CHANNEL_4_NUMBER |                                                  \
   ADC_CHANNEL_4_SMP) /*!< ADC external channel (channel connected to GPIO \
                         pin) ADCx_IN4  */
#define LL_ADC_CHANNEL_5                                                   \
  (ADC_CHANNEL_5_NUMBER |                                                  \
   ADC_CHANNEL_5_SMP) /*!< ADC external channel (channel connected to GPIO \
                         pin) ADCx_IN5  */
#define LL_ADC_CHANNEL_6                                                   \
  (ADC_CHANNEL_6_NUMBER |                                                  \
   ADC_CHANNEL_6_SMP) /*!< ADC external channel (channel connected to GPIO \
                         pin) ADCx_IN6  */
#define LL_ADC_CHANNEL_7                                                   \
  (ADC_CHANNEL_7_NUMBER |                                                  \
   ADC_CHANNEL_7_SMP) /*!< ADC external channel (channel connected to GPIO \
                         pin) ADCx_IN7  */
#define LL_ADC_CHANNEL_8                                                   \
  (ADC_CHANNEL_8_NUMBER |                                                  \
   ADC_CHANNEL_8_SMP) /*!< ADC external channel (channel connected to GPIO \
                         pin) ADCx_IN8  */
#define LL_ADC_CHANNEL_9                                                   \
  (ADC_CHANNEL_9_NUMBER |                                                  \
   ADC_CHANNEL_9_SMP) /*!< ADC external channel (channel connected to GPIO \
                         pin) ADCx_IN9  */
#define LL_ADC_CHANNEL_10                                                   \
  (ADC_CHANNEL_10_NUMBER |                                                  \
   ADC_CHANNEL_10_SMP) /*!< ADC external channel (channel connected to GPIO \
                          pin) ADCx_IN10 */
#define LL_ADC_CHANNEL_11                                                   \
  (ADC_CHANNEL_11_NUMBER |                                                  \
   ADC_CHANNEL_11_SMP) /*!< ADC external channel (channel connected to GPIO \
                          pin) ADCx_IN11 */
#define LL_ADC_CHANNEL_12                                                   \
  (ADC_CHANNEL_12_NUMBER |                                                  \
   ADC_CHANNEL_12_SMP) /*!< ADC external channel (channel connected to GPIO \
                          pin) ADCx_IN12 */
#define LL_ADC_CHANNEL_13                                                   \
  (ADC_CHANNEL_13_NUMBER |                                                  \
   ADC_CHANNEL_13_SMP) /*!< ADC external channel (channel connected to GPIO \
                          pin) ADCx_IN13 */
#define LL_ADC_CHANNEL_14                                                   \
  (ADC_CHANNEL_14_NUMBER |                                                  \
   ADC_CHANNEL_14_SMP) /*!< ADC external channel (channel connected to GPIO \
                          pin) ADCx_IN14 */
#define LL_ADC_CHANNEL_15                                                   \
  (ADC_CHANNEL_15_NUMBER |                                                  \
   ADC_CHANNEL_15_SMP) /*!< ADC external channel (channel connected to GPIO \
                          pin) ADCx_IN15 */
#define LL_ADC_CHANNEL_16                                                   \
  (ADC_CHANNEL_16_NUMBER |                                                  \
   ADC_CHANNEL_16_SMP) /*!< ADC external channel (channel connected to GPIO \
                          pin) ADCx_IN16 */
#define LL_ADC_CHANNEL_17                                                   \
  (ADC_CHANNEL_17_NUMBER |                                                  \
   ADC_CHANNEL_17_SMP) /*!< ADC external channel (channel connected to GPIO \
                          pin) ADCx_IN17 */
#define LL_ADC_CHANNEL_18                                                   \
  (ADC_CHANNEL_18_NUMBER |                                                  \
   ADC_CHANNEL_18_SMP) /*!< ADC external channel (channel connected to GPIO \
                          pin) ADCx_IN18 */
#define LL_ADC_CHANNEL_VREFINT                                                 \
  (LL_ADC_CHANNEL_17 |                                                         \
   ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to VrefInt: \
                                  Internal voltage reference. On STM32F4, ADC  \
                                  channel available only on ADC instance:      \
                                  ADC1. */
#define LL_ADC_CHANNEL_VBAT                                                   \
  (LL_ADC_CHANNEL_18 |                                                        \
   ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to Vbat/3: \
                                  ...
                                  On STM32F4, ADC channel available only on   \
                                  ADC instance: ADC1. */
#if defined(STM32F401xC) || defined(STM32F401xE) || defined(STM32F405xx) || \
    defined(STM32F407xx) || defined(STM32F410Tx) || defined(STM32F410Cx) || \
    defined(STM32F410Rx) || defined(STM32F415xx) || defined(STM32F417xx)
#define LL_ADC_CHANNEL_TEMPSENSOR                                             \
  (LL_ADC_CHANNEL_16 |                                                        \
   ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to         \
                                  Temperature sensor. On STM32F4, ADC channel \
                                  available only on ADC instance: ADC1. */
#endif /* STM32F405xx || STM32F415xx || STM32F407xx || STM32F417xx || \
          STM32F401xC || STM32F401xE || STM32F410xx */
#if defined(STM32F411xE) || defined(STM32F412Cx) || defined(STM32F412Rx) || \
    defined(STM32F412Vx) || defined(STM32F412Zx) || defined(STM32F413xx) || \
    defined(STM32F423xx) || defined(STM32F427xx) || defined(STM32F437xx) || \
    defined(STM32F429xx) || defined(STM32F439xx) || defined(STM32F446xx) || \
    defined(STM32F469xx) || defined(STM32F479xx)
#define LL_ADC_CHANNEL_TEMPSENSOR                                             \
  (LL_ADC_CHANNEL_18 | ADC_CHANNEL_ID_INTERNAL_CH |                           \
   ADC_CHANNEL_DIFFERENCIATION_TEMPSENSOR_VBAT) /*!< ADC internal channel     \
                                                   connected to Temperature   \
                                                   sensor. On STM32F4, ADC    \
                                                   channel available only on  \
                                                   ADC instance: ADC1. This   \
                                                   internal channel is shared \
                                                   between temperature sensor \
                                                   and Vbat, only 1           \
                                                   measurement path must be   \
                                                   enabled. */
#endif /* STM32F411xE || STM32F412Cx || STM32F412Rx || STM32F412Vx || \
          STM32F412Zx || STM32F413xx || STM32F423xx || STM32F427xx || \
...
#define LL_ADC_REG_TRIG_EXT_TIM1_CH1                                           \
  (ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM1 channel 1 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM1_CH2                                           \
  (ADC_CR2_EXTSEL_0 |                                                          \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM1 channel 2 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM1_CH3                                           \
  (ADC_CR2_EXTSEL_1 |                                                          \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM1 channel 3 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM2_CH2                                           \
  (ADC_CR2_EXTSEL_1 | ADC_CR2_EXTSEL_0 |                                       \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM2 channel 2 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM2_CH3                                           \
  (ADC_CR2_EXTSEL_2 |                                                          \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM2 channel 3 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM2_CH4                                           \
  (ADC_CR2_EXTSEL_2 | ADC_CR2_EXTSEL_0 |                                       \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM2 channel 4 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
...
#define LL_ADC_REG_TRIG_EXT_TIM3_TRGO                                          \
  (ADC_CR2_EXTSEL_3 |                                                          \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM3 TRGO. Trigger edge \
                                     set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM4_CH4                                           \
  (ADC_CR2_EXTSEL_3 | ADC_CR2_EXTSEL_0 |                                       \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM4 channel 4 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM5_CH1                                           \
  (ADC_CR2_EXTSEL_3 | ADC_CR2_EXTSEL_1 |                                       \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM5 channel 1 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM5_CH2                                           \
  (ADC_CR2_EXTSEL_3 | ADC_CR2_EXTSEL_1 | ADC_CR2_EXTSEL_0 |                    \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM5 channel 2 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM5_CH3                                           \
  (ADC_CR2_EXTSEL_3 | ADC_CR2_EXTSEL_2 |                                       \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM5 channel 3 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM8_CH1                                           \
  (ADC_CR2_EXTSEL_3 | ADC_CR2_EXTSEL_2 | ADC_CR2_EXTSEL_0 |                    \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM8 channel 1 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM8_TRGO                                          \
  (ADC_CR2_EXTSEL_3 | ADC_CR2_EXTSEL_2 | ADC_CR2_EXTSEL_1 |                    \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: TIM8 TRGO. Trigger edge \
                                     set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_EXTI_LINE11                                        \
  (ADC_CR2_EXTSEL_3 | ADC_CR2_EXTSEL_2 | ADC_CR2_EXTSEL_1 | ADC_CR2_EXTSEL_0 | \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external IP: external interrupt      \
                                     line 11. Trigger edge set to rising edge  \
                                     (default setting). */
/**
 * @}
 */
...
#define LL_ADC_REG_TRIG_EXT_RISING                                            \
  (ADC_CR2_EXTEN_0) /*!< ADC group regular conversion trigger polarity set to \
                       rising edge */
#define LL_ADC_REG_TRIG_EXT_FALLING                                           \
  (ADC_CR2_EXTEN_1) /*!< ADC group regular conversion trigger polarity set to \
                       falling edge */
...
#define LL_ADC_REG_CONV_CONTINUOUS                                            \
  (ADC_CR2_CONT) /*!< ADC conversions are performed in continuous mode: after \
...
#define LL_ADC_REG_DMA_TRANSFER_LIMITED                                     \
  (ADC_CR2_DMA) /*!< ADC conversion data are transferred by DMA, in limited \
...
#define LL_ADC_REG_DMA_TRANSFER_UNLIMITED                                     \
  (ADC_CR2_DDS |                                                              \
   ADC_CR2_DMA) /*!< ADC conversion data are transferred by DMA, in unlimited \
                   mode: DMA transfer requests are unlimited, whatever number \
                   of DMA data transferred (number of ADC conversions). This  \
                   ADC mode is intended to be used with DMA mode circular. */
/**
 * @}
 */

/** @defgroup ADC_LL_EC_REG_FLAG_EOC_SELECTION ADC group regular - Flag EOC
 * selection (unitary or sequence conversions)
 * @{
 */
#define LL_ADC_REG_FLAG_EOC_SEQUENCE_CONV \
  0x00000000UL /*!< ADC flag EOC (end of unitary conversion) selected */
#define LL_ADC_REG_FLAG_EOC_UNITARY_CONV \
  (ADC_CR2_EOCS) /*!< ADC flag EOS (end of sequence conversions) selected */
/**
 * @}
 */
...
#define LL_ADC_REG_SEQ_DISCONT_1RANK                                          \
  (ADC_CR1_DISCEN) /*!< ADC group regular sequencer discontinuous mode enable \
                      with sequence interruption every rank */
#define LL_ADC_REG_SEQ_DISCONT_2RANKS                                          \
  (ADC_CR1_DISCNUM_0 |                                                         \
   ADC_CR1_DISCEN) /*!< ADC group regular sequencer discontinuous mode enabled \
                      with sequence interruption every 2 ranks */
...
#define LL_ADC_INJ_TRIG_SOFTWARE                                              \
  0x00000000UL /*!< ADC group injected conversion trigger internal: SW start. \
                */
#define LL_ADC_INJ_TRIG_EXT_TIM1_CH4                                           \
  (ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM1 channel 4 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM1_TRGO                                          \
  (ADC_CR2_JEXTSEL_0 |                                                         \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM1 TRGO. Trigger edge \
                                     set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM2_CH1                                           \
  (ADC_CR2_JEXTSEL_1 |                                                         \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM2 channel 1 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
...
#define LL_ADC_INJ_TRIG_EXT_TIM3_CH2                                           \
  (ADC_CR2_JEXTSEL_2 |                                                         \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM3 channel 2 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM3_CH4                                           \
  (ADC_CR2_JEXTSEL_2 | ADC_CR2_JEXTSEL_0 |                                     \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM3 channel 4 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM4_CH1                                           \
  (ADC_CR2_JEXTSEL_2 | ADC_CR2_JEXTSEL_1 |                                     \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM4 channel 1 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM4_CH2                                           \
  (ADC_CR2_JEXTSEL_2 | ADC_CR2_JEXTSEL_1 | ADC_CR2_JEXTSEL_0 |                 \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM4 channel 2 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM4_CH3                                           \
  (ADC_CR2_JEXTSEL_3 |                                                         \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM4 channel 3 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM4_TRGO                                          \
  (ADC_CR2_JEXTSEL_3 | ADC_CR2_JEXTSEL_0 |                                     \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM4 TRGO. Trigger edge \
                                     set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM5_CH4                                           \
  (ADC_CR2_JEXTSEL_3 | ADC_CR2_JEXTSEL_1 |                                     \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM5 channel 4 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM5_TRGO                                          \
  (ADC_CR2_JEXTSEL_3 | ADC_CR2_JEXTSEL_1 | ADC_CR2_JEXTSEL_0 |                 \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM5 TRGO. Trigger edge \
                                     set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM8_CH2                                           \
  (ADC_CR2_JEXTSEL_3 | ADC_CR2_JEXTSEL_2 |                                     \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM8 channel 2 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM8_CH3                                           \
  (ADC_CR2_JEXTSEL_3 | ADC_CR2_JEXTSEL_2 | ADC_CR2_JEXTSEL_0 |                 \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM8 channel 3 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM8_CH4                                           \
  (ADC_CR2_JEXTSEL_3 | ADC_CR2_JEXTSEL_2 | ADC_CR2_JEXTSEL_1 |                 \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external IP: TIM8 channel 4 event    \
                                     (capture compare: input capture or output \
                                     capture). Trigger edge set to rising edge \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_EXTI_LINE15                                       \
  (ADC_CR2_JEXTSEL_3 | ADC_CR2_JEXTSEL_2 | ADC_CR2_JEXTSEL_1 |                \
   ...
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger  \
                                     from external IP: external interrupt     \
                                     line 15. Trigger edge set to rising edge \
                                     (default setting). */
/**
 * @}
 */
...
#define LL_ADC_INJ_TRIG_EXT_RISING                                           \
  (ADC_CR2_JEXTEN_0) /*!< ADC group injected conversion trigger polarity set \
                        to rising edge */
#define LL_ADC_INJ_TRIG_EXT_FALLING                                          \
  (ADC_CR2_JEXTEN_1) /*!< ADC group injected conversion trigger polarity set \
                        to falling edge */
...
#define LL_ADC_INJ_TRIG_INDEPENDENT                                            \
  0x00000000UL /*!< ADC group injected conversion trigger independent. Setting \
                  mandatory if ADC group injected injected trigger source is   \
                  set to an external trigger. */
#define LL_ADC_INJ_TRIG_FROM_GRP_REGULAR                                      \
  (ADC_CR1_JAUTO) /*!< ADC group injected conversion trigger from ADC group   \
...
#define LL_ADC_INJ_SEQ_DISCONT_1RANK                                     \
  (ADC_CR1_JDISCEN) /*!< ADC group injected sequencer discontinuous mode \
...
#define LL_ADC_INJ_RANK_1                     \
  (ADC_JDR1_REGOFFSET | ADC_JOFR1_REGOFFSET | \
   0x00000001UL) /*!< ADC group injected sequencer rank 1 */
#define LL_ADC_INJ_RANK_2                     \
  (ADC_JDR2_REGOFFSET | ADC_JOFR2_REGOFFSET | \
   0x00000002UL) /*!< ADC group injected sequencer rank 2 */
#define LL_ADC_INJ_RANK_3                     \
  (ADC_JDR3_REGOFFSET | ADC_JOFR3_REGOFFSET | \
   0x00000003UL) /*!< ADC group injected sequencer rank 3 */
#define LL_ADC_INJ_RANK_4                     \
  (ADC_JDR4_REGOFFSET | ADC_JOFR4_REGOFFSET | \
   0x00000004UL) /*!< ADC group injected sequencer rank 4 */
/**
 * @}
 */
...
#define LL_ADC_SAMPLINGTIME_3CYCLES \
  0x00000000UL /*!< Sampling time 3 ADC clock cycles */
#define LL_ADC_SAMPLINGTIME_15CYCLES \
  (ADC_SMPR1_SMP10_0) /*!< Sampling time 15 ADC clock cycles */
#define LL_ADC_SAMPLINGTIME_28CYCLES \
  (ADC_SMPR1_SMP10_1) /*!< Sampling time 28 ADC clock cycles */
#define LL_ADC_SAMPLINGTIME_56CYCLES \
  (ADC_SMPR1_SMP10_1 |               \
   ADC_SMPR1_SMP10_0) /*!< Sampling time 56 ADC clock cycles */
#define LL_ADC_SAMPLINGTIME_84CYCLES \
  (ADC_SMPR1_SMP10_2) /*!< Sampling time 84 ADC clock cycles */
#define LL_ADC_SAMPLINGTIME_112CYCLES \
  (ADC_SMPR1_SMP10_2 |                \
   ADC_SMPR1_SMP10_0) /*!< Sampling time 112 ADC clock cycles */
#define LL_ADC_SAMPLINGTIME_144CYCLES \
  (ADC_SMPR1_SMP10_2 |                \
   ADC_SMPR1_SMP10_1) /*!< Sampling time 144 ADC clock cycles */
#define LL_ADC_SAMPLINGTIME_480CYCLES \
  (ADC_SMPR1_SMP10) /*!< Sampling time 480 ADC clock cycles */
/**
 * @}
 */
...
#define LL_ADC_AWD_ALL_CHANNELS_REG                                    \
  (ADC_CR1_AWDEN) /*!< ADC analog watchdog monitoring of all channels, \
                     converted by group regular only */
#define LL_ADC_AWD_ALL_CHANNELS_INJ                                     \
  (ADC_CR1_JAWDEN) /*!< ADC analog watchdog monitoring of all channels, \
...
#define LL_ADC_AWD_CHANNEL_0_REG                                               \
  ((LL_ADC_CHANNEL_0 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                  \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel \
                      (channel connected to GPIO pin) ADCx_IN0, converted by   \
                      group regular only */
...
#define LL_ADC_AWD_CHANNEL_1_REG                                               \
  ((LL_ADC_CHANNEL_1 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                  \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel \
                      (channel connected to GPIO pin) ADCx_IN1, converted by   \
                      group regular only */
...
#define LL_ADC_AWD_CHANNEL_2_REG                                               \
  ((LL_ADC_CHANNEL_2 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                  \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel \
                      (channel connected to GPIO pin) ADCx_IN2, converted by   \
                      group regular only */
...
#define LL_ADC_AWD_CHANNEL_3_REG                                               \
  ((LL_ADC_CHANNEL_3 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                  \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel \
                      (channel connected to GPIO pin) ADCx_IN3, converted by   \
                      group regular only */
...
#define LL_ADC_AWD_CHANNEL_4_REG                                               \
  ((LL_ADC_CHANNEL_4 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                  \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel \
                      (channel connected to GPIO pin) ADCx_IN4, converted by   \
                      group regular only */
...
#define LL_ADC_AWD_CHANNEL_5_REG                                               \
  ((LL_ADC_CHANNEL_5 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                  \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel \
                      (channel connected to GPIO pin) ADCx_IN5, converted by   \
                      group regular only */
...
#define LL_ADC_AWD_CHANNEL_6_REG                                               \
  ((LL_ADC_CHANNEL_6 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                  \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel \
                      (channel connected to GPIO pin) ADCx_IN6, converted by   \
                      group regular only */
...
#define LL_ADC_AWD_CHANNEL_7_REG                                               \
  ((LL_ADC_CHANNEL_7 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                  \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel \
                      (channel connected to GPIO pin) ADCx_IN7, converted by   \
                      group regular only */
...
#define LL_ADC_AWD_CHANNEL_8_REG                                               \
  ((LL_ADC_CHANNEL_8 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                  \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel \
                      (channel connected to GPIO pin) ADCx_IN8, converted by   \
                      group regular only */
...
#define LL_ADC_AWD_CHANNEL_9_REG                                               \
  ((LL_ADC_CHANNEL_9 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                  \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel \
                      (channel connected to GPIO pin) ADCx_IN9, converted by   \
                      group regular only */
...
#define LL_ADC_AWD_CHANNEL_10_REG                                              \
  ((LL_ADC_CHANNEL_10 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                 \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel \
                      (channel connected to GPIO pin) ADCx_IN10, converted by  \
                      group regular only */
...
#define LL_ADC_AWD_CHANNEL_11_REG                                              \
  ((LL_ADC_CHANNEL_11 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                 \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel \
                      (channel connected to GPIO pin) ADCx_IN11, converted by  \
                      group regular only */
...
#define LL_ADC_AWD_CHANNEL_12_REG                                              \
  ((LL_ADC_CHANNEL_12 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                 \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel \
                      (channel connected to GPIO pin) ADCx_IN12, converted by  \
                      group regular only */
...
#define LL_ADC_AWD_CHANNEL_13_REG                                              \
  ((LL_ADC_CHANNEL_13 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                 \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel \
                      (channel connected to GPIO pin) ADCx_IN13, converted by  \
                      group regular only */
...
#define LL_ADC_AWD_CHANNEL_14_REG                                              \
  ((LL_ADC_CHANNEL_14 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                 \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel \
                      (channel connected to GPIO pin) ADCx_IN14, converted by  \
                      group regular only */
...
#define LL_ADC_AWD_CHANNEL_15_REG                                              \
  ((LL_ADC_CHANNEL_15 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                 \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel \
                      (channel connected to GPIO pin) ADCx_IN15, converted by  \
                      group regular only */
...
#define LL_ADC_AWD_CHANNEL_16_REG                                              \
  ((LL_ADC_CHANNEL_16 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                 \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel \
                      (channel connected to GPIO pin) ADCx_IN16, converted by  \
                      group regular only */
...
#define LL_ADC_AWD_CHANNEL_17_REG                                              \
  ((LL_ADC_CHANNEL_17 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                 \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel \
                      (channel connected to GPIO pin) ADCx_IN17, converted by  \
                      group regular only */
...
#define LL_ADC_AWD_CHANNEL_18_REG                                              \
  ((LL_ADC_CHANNEL_18 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                 \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel \
                      (channel connected to GPIO pin) ADCx_IN18, converted by  \
                      group regular only */
...
#define LL_ADC_AWD_CH_VREFINT_REG                                              \
  ((LL_ADC_CHANNEL_VREFINT & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |            \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal channel \
...
#define LL_ADC_AWD_CH_VBAT_REG                                                 \
  ((LL_ADC_CHANNEL_VBAT & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |               \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal channel \
                      connected to Vbat/3: Vbat voltage through a divider      \
...
#define LL_ADC_AWD_CH_TEMPSENSOR_REG                                           \
  ((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |         \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal channel \
                      connected to Temperature sensor, converted by group      \
                      regular only */
...
#define LL_ADC_AWD_CH_TEMPSENSOR_REG_INJ                                       \
  ((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |        \
   ADC_CR1_AWDEN |                                                             \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal channel \
                      connected to Temperature sensor, converted by either     \
...
#define LL_ADC_AWD_CH_TEMPSENSOR_REG                                           \
  ((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |         \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal channel \
                      connected to Temperature sensor, converted by group      \
                      regular only. This internal channel is shared between    \
                      temperature sensor and Vbat, only 1 measurement path     \
                      must be enabled. */
#define LL_ADC_AWD_CH_TEMPSENSOR_INJ                                           \
  ((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |        \
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal channel \
                      connected to Temperature sensor, converted by group      \
                      injected only. This internal channel is shared between   \
                      temperature sensor and Vbat, only 1 measurement path     \
                      must be enabled. */
#define LL_ADC_AWD_CH_TEMPSENSOR_REG_INJ                                       \
  ((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |        \
   ...
   ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal channel \
                      connected to Temperature sensor, converted by either     \
                      group regular or injected. This internal channel is      \
                      shared between temperature sensor and Vbat, only 1       \
...
#define LL_ADC_AWD_THRESHOLD_HIGH \
  (ADC_AWD_TR1_HIGH_REGOFFSET) /*!< ADC analog watchdog threshold high */
#define LL_ADC_AWD_THRESHOLD_LOW \
  (ADC_AWD_TR1_LOW_REGOFFSET) /*!< ADC analog watchdog threshold low */
/**
 * @}
 */
...
#define LL_ADC_MULTI_DUAL_REG_INTERL                                   \
  (ADC_CCR_MULTI_2 | ADC_CCR_MULTI_1 |                                 \
   ADC_CCR_MULTI_0) /*!< ADC dual mode enabled: Combined group regular \
                       interleaved */
#define LL_ADC_MULTI_DUAL_INJ_SIMULT \
  (ADC_CCR_MULTI_2 |                 \
   ADC_CCR_MULTI_0) /*!< ADC dual mode enabled: group injected simultaneous */
#define LL_ADC_MULTI_DUAL_INJ_ALTERN                                     \
  (ADC_CCR_MULTI_3 |                                                     \
   ADC_CCR_MULTI_0) /*!< ADC dual mode enabled: group injected alternate \
...
#define LL_ADC_MULTI_DUAL_REG_SIM_INJ_ALT                              \
  (ADC_CCR_MULTI_1) /*!< ADC dual mode enabled: Combined group regular \
...
#define LL_ADC_MULTI_TRIPLE_REG_SIM_INJ_SIM                              \
  (ADC_CCR_MULTI_4 |                                                     \
   ADC_CCR_MULTI_0) /*!< ADC triple mode enabled: Combined group regular \
                       simultaneous + group injected simultaneous */
#define LL_ADC_MULTI_TRIPLE_REG_SIM_INJ_ALT                              \
  (ADC_CCR_MULTI_4 |                                                     \
   ADC_CCR_MULTI_1) /*!< ADC triple mode enabled: Combined group regular \
                       simultaneous + group injected alternate trigger */
#define LL_ADC_MULTI_TRIPLE_INJ_SIMULT                                        \
  (ADC_CCR_MULTI_4 | ADC_CCR_MULTI_2 |                                        \
   ADC_CCR_MULTI_0) /*!< ADC triple mode enabled: group injected simultaneous \
                     */
...
#define LL_ADC_MULTI_TRIPLE_INJ_ALTERN                                     \
  (ADC_CCR_MULTI_4 |                                                       \
   ADC_CCR_MULTI_0) /*!< ADC triple mode enabled: group injected alternate \
                       trigger. Works only with external triggers (not     \
                       internal SW start) */
#endif
/**
...
#define LL_ADC_MULTI_REG_DMA_EACH_ADC                                          \
  0x00000000UL /*!< ADC multimode group regular conversions are transferred by \
                  DMA: each ADC uses its own DMA channel, with its individual  \
                  DMA transfer settings */
#define LL_ADC_MULTI_REG_DMA_LIMIT_1                                           \
  (ADC_CCR_DMA_0) /*!< ADC multimode group regular conversions are transferred \
                     by DMA, one DMA channel for all ADC instances (DMA of ADC \
                     master), in limited mode (one shot mode): DMA transfer    \
                     requests are stopped when number of DMA data transfers    \
                     (number of ADC conversions) is reached. This ADC mode is  \
                     intended to be used with DMA mode non-circular. Setting   \
                     of DMA mode 1: 2 or 3 (dual or triple mode) half-words    \
                     one by one, ADC1 then ADC2 then ADC3. */
#define LL_ADC_MULTI_REG_DMA_LIMIT_2                                           \
  (ADC_CCR_DMA_1) /*!< ADC multimode group regular conversions are transferred \
                     by DMA, one DMA channel for all ADC instances (DMA of ADC \
                     master), in limited mode (one shot mode): DMA transfer    \
                     requests are stopped when number of DMA data transfers    \
                     (number of ADC conversions) is reached. This ADC mode is  \
                     intended to be used with DMA mode non-circular. Setting   \
                     of DMA mode 2: 2 or 3 (dual or triple mode) half-words    \
                     one by one, ADC2&1 then ADC1&3 then ADC3&2. */
#define LL_ADC_MULTI_REG_DMA_LIMIT_3                                           \
  (ADC_CCR_DMA_1 |                                                             \
   ADC_CCR_DMA_0) /*!< ADC multimode group regular conversions are transferred \
                     ...
                     (number of ADC conversions) is reached. This ADC mode is  \
                     intended to be used with DMA mode non-circular. Setting   \
                     of DMA mode 3: 2 or 3 (dual or triple mode) bytes one by  \
                     one, ADC2&1 then ADC1&3 then ADC3&2. */
#define LL_ADC_MULTI_REG_DMA_UNLMT_1                                           \
  (ADC_CCR_DDS |                                                               \
   ADC_CCR_DMA_0) /*!< ADC multimode group regular conversions are transferred \
                     by DMA, one DMA channel for all ADC instances (DMA of ADC \
                     master), in unlimited mode: DMA transfer requests are     \
                     unlimited, whatever number of DMA data transferred        \
                     (number of ADC conversions) is reached. This ADC mode is  \
                     intended to be used with DMA mode non-circular. Setting   \
                     of DMA mode 1: 2 or 3 (dual or triple mode) half-words    \
                     one by one, ADC1 then ADC2 then ADC3. */
#define LL_ADC_MULTI_REG_DMA_UNLMT_2                                           \
  (ADC_CCR_DDS |                                                               \
   ADC_CCR_DMA_1) /*!< ADC multimode group regular conversions are transferred \
                     ...
                     (number of ADC conversions) is reached. This ADC mode is  \
                     intended to be used with DMA mode non-circular. Setting   \
                     of DMA mode 2: 2 or 3 (dual or triple mode) half-words by \
                     pairs, ADC2&1 then ADC1&3 then ADC3&2. */
...
#define LL_ADC_MULTI_TWOSMP_DELAY_5CYCLES                                  \
  0x00000000UL /*!< ADC multimode delay between two sampling phases: 5 ADC \
                  clock cycles*/
...
#define LL_ADC_MULTI_TWOSMP_DELAY_9CYCLES                                   \
  (ADC_CCR_DELAY_2) /*!< ADC multimode delay between two sampling phases: 9 \
                       ADC clock cycles */
...
#define LL_ADC_MULTI_TWOSMP_DELAY_13CYCLES                                   \
  (ADC_CCR_DELAY_3) /*!< ADC multimode delay between two sampling phases: 13 \
                       ADC clock cycles */
#define LL_ADC_MULTI_TWOSMP_DELAY_14CYCLES                                   \
  (ADC_CCR_DELAY_3 |                                                         \
   ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 14 \
                       ADC clock cycles */
#define LL_ADC_MULTI_TWOSMP_DELAY_15CYCLES                                   \
  (ADC_CCR_DELAY_3 |                                                         \
   ADC_CCR_DELAY_1) /*!< ADC multimode delay between two sampling phases: 15 \
                       ADC clock cycles */
#define LL_ADC_MULTI_TWOSMP_DELAY_16CYCLES                                   \
  (ADC_CCR_DELAY_3 | ADC_CCR_DELAY_1 |                                       \
   ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 16 \
                       ADC clock cycles */
#define LL_ADC_MULTI_TWOSMP_DELAY_17CYCLES                                   \
  (ADC_CCR_DELAY_3 |                                                         \
   ADC_CCR_DELAY_2) /*!< ADC multimode delay between two sampling phases: 17 \
                       ADC clock cycles */
#define LL_ADC_MULTI_TWOSMP_DELAY_18CYCLES                                   \
  (ADC_CCR_DELAY_3 | ADC_CCR_DELAY_2 |                                       \
   ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 18 \
                       ADC clock cycles */
#define LL_ADC_MULTI_TWOSMP_DELAY_19CYCLES                                   \
  (ADC_CCR_DELAY_3 | ADC_CCR_DELAY_2 |                                       \
   ADC_CCR_DELAY_1) /*!< ADC multimode delay between two sampling phases: 19 \
                       ADC clock cycles */
#define LL_ADC_MULTI_TWOSMP_DELAY_20CYCLES                                   \
  (ADC_CCR_DELAY_3 | ADC_CCR_DELAY_2 | ADC_CCR_DELAY_1 |                     \
   ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 20 \
                       ADC clock cycles */
/**
 * @}
 */
...
#define LL_ADC_DELAY_VREFINT_STAB_US \
  (10UL) /*!< Delay for internal voltage reference stabilization time */
 ...
 *         (2) On devices STM32F42x and STM32F43x, limitation: this internal
...
#define __LL_ADC_MULTI_CONV_DATA_MASTER_SLAVE(__ADC_MULTI_MASTER_SLAVE__,      \
  ...
  (((__ADC_MULTI_CONV_DATA__) >> POSITION_VAL((__ADC_MULTI_MASTER_SLAVE__))) & \
   ADC_CDR_RDATA_MST)
#endif
...
#if !defined(STM32F469) && !defined(STM32F479xx) && !defined(STM32F429xx) && \
    !defined(STM32F439xx)
/**
 ...
 * sensor slope typical value (unit uV/DegCelsius). On STM32F4, refer to device
 ...
 * below) (unit mV). On STM32F4, refer to device datasheet parameter "V25".
...
LL_ADC_GetCommonPathInternalCh(const ADC_Common_TypeDef *ADCxy_COMMON) {
  return (
      uint32_t)(READ_BIT(ADCxy_COMMON->CCR, ADC_CCR_TSVREFE | ADC_CCR_VBATE));
}
...
__STATIC_INLINE uint32_t LL_ADC_REG_GetTriggerSource(const ADC_TypeDef *ADCx) {
  ...
  uint32_t ShiftExten = ((TriggerSource & ADC_CR2_EXTEN) >>
...
__STATIC_INLINE void LL_ADC_REG_SetSequencerRanks(ADC_TypeDef *ADCx,
  ...
  __IO uint32_t *preg = __ADC_PTR_REG_OFFSET(
      ADCx->SQR1, __ADC_MASK_SHIFT(Rank, ADC_REG_SQRX_REGOFFSET_MASK));
...
__STATIC_INLINE uint32_t LL_ADC_REG_GetSequencerRanks(const ADC_TypeDef *ADCx,
                                                      uint32_t Rank) {
  __IO uint32_t const *preg = __ADC_PTR_REG_OFFSET(
      ADCx->SQR1, __ADC_MASK_SHIFT(Rank, ADC_REG_SQRX_REGOFFSET_MASK));

  return (
      uint32_t)(READ_BIT(*preg, ADC_CHANNEL_ID_NUMBER_MASK
                                    << (Rank & ADC_REG_RANK_ID_SQRX_MASK)) >>
                (Rank & ADC_REG_RANK_ID_SQRX_MASK));
}
 ...
 */
__STATIC_INLINE uint32_t
LL_ADC_REG_GetFlagEndOfConversion(const ADC_TypeDef *ADCx) {
...
__STATIC_INLINE uint32_t LL_ADC_INJ_GetTriggerSource(const ADC_TypeDef *ADCx) {
  uint32_t TriggerSource =
      READ_BIT(ADCx->CR2, ADC_CR2_JEXTSEL | ADC_CR2_JEXTEN);

  /* Value for shift of {0; 4; 8; 12} depending on value of bitfield          */
  /* corresponding to ADC_CR2_JEXTEN {0; 1; 2; 3}.                            */
  uint32_t ShiftExten = ((TriggerSource & ADC_CR2_JEXTEN) >>
...
__STATIC_INLINE void LL_ADC_INJ_SetSequencerRanks(ADC_TypeDef *ADCx,
  ...
  /* other bits reserved for other purpose.                                   */
  uint32_t tmpreg1 =
      (READ_BIT(ADCx->JSQR, ADC_JSQR_JL) >> ADC_JSQR_JL_Pos) + 1UL;
...
__STATIC_INLINE void LL_ADC_INJ_SetOffset(ADC_TypeDef *ADCx, uint32_t Rank,
  ...
  __IO uint32_t *preg = __ADC_PTR_REG_OFFSET(
      ADCx->JOFR1, __ADC_MASK_SHIFT(Rank, ADC_INJ_JOFRX_REGOFFSET_MASK));
 ...
 * @note   It gives offset level (offset to be subtracted from the raw converted
 * data). Caution: Offset format is dependent to ADC resolution: offset has to
 * be left-aligned on bit 11, the LSB (right bits) are set to 0.
...
__STATIC_INLINE void LL_ADC_SetChannelSamplingTime(ADC_TypeDef *ADCx,
  ...
  /* other bits reserved for other purpose.                                   */
  __IO uint32_t *preg = __ADC_PTR_REG_OFFSET(
      ADCx->SMPR1, __ADC_MASK_SHIFT(Channel, ADC_CHANNEL_SMPRX_REGOFFSET_MASK));

  MODIFY_REG(*preg,
             ADC_SMPR2_SMP0
                 << __ADC_MASK_SHIFT(Channel, ADC_CHANNEL_SMPx_BITOFFSET_MASK),
             SamplingTime << __ADC_MASK_SHIFT(Channel,
...
__STATIC_INLINE uint32_t LL_ADC_GetChannelSamplingTime(const ADC_TypeDef *ADCx,
  ...
  return (uint32_t)(READ_BIT(*preg,
                             ADC_SMPR2_SMP0 << __ADC_MASK_SHIFT(
 ...
 */
__STATIC_INLINE uint32_t
LL_ADC_GetAnalogWDMonitChannels(const ADC_TypeDef *ADCx) {
  return (uint32_t)(READ_BIT(ADCx->CR1, (ADC_CR1_AWDEN | ADC_CR1_JAWDEN |
...
__STATIC_INLINE uint32_t LL_ADC_GetAnalogWDThresholds(
  ...
  __IO uint32_t const *preg =
      __ADC_PTR_REG_OFFSET(ADCx->HTR, AWDThresholdsHighLow);
...
__STATIC_INLINE uint32_t LL_ADC_REG_ReadMultiConversionData32(
  ...
  return (uint32_t)(READ_BIT(ADCxy_COMMON->CDR, ADC_DR_ADC2DATA) >>
...
LL_ADC_INJ_ReadConversionData32(const ADC_TypeDef *ADCx, uint32_t Rank) {
  __IO uint32_t const *preg = __ADC_PTR_REG_OFFSET(
      ADCx->JDR1, __ADC_MASK_SHIFT(Rank, ADC_INJ_JDRX_REGOFFSET_MASK));
 ...
 */
__STATIC_INLINE uint32_t
LL_ADC_IsActiveFlag_MST_EOCS(const ADC_Common_TypeDef *ADCxy_COMMON) {
  return (READ_BIT(ADCxy_COMMON->CSR, LL_ADC_FLAG_EOCS_MST) ==
 ...
 */
__STATIC_INLINE uint32_t
LL_ADC_IsActiveFlag_SLV1_EOCS(const ADC_Common_TypeDef *ADCxy_COMMON) {
 ...
 */
__STATIC_INLINE uint32_t
LL_ADC_IsActiveFlag_SLV2_EOCS(const ADC_Common_TypeDef *ADCxy_COMMON) {
 ...
 */
__STATIC_INLINE uint32_t
LL_ADC_IsActiveFlag_SLV1_OVR(const ADC_Common_TypeDef *ADCxy_COMMON) {
 ...
 */
__STATIC_INLINE uint32_t
LL_ADC_IsActiveFlag_SLV2_OVR(const ADC_Common_TypeDef *ADCxy_COMMON) {
 ...
 */
__STATIC_INLINE uint32_t
LL_ADC_IsActiveFlag_SLV1_JEOS(const ADC_Common_TypeDef *ADCxy_COMMON) {
  /* Note: on this STM32 series, there is no flag ADC group injected          */
  /*       end of unitary conversion.                                         */
  /*       Flag noted as "JEOC" is corresponding to flag "JEOS"               */
  /*       in other STM32 families).                                          */
 ...
 */
__STATIC_INLINE uint32_t
LL_ADC_IsActiveFlag_SLV2_JEOS(const ADC_Common_TypeDef *ADCxy_COMMON) {
  /* Note: on this STM32 series, there is no flag ADC group injected          */
  /*       end of unitary conversion.                                         */
  /*       Flag noted as "JEOC" is corresponding to flag "JEOS"               */
  /*       in other STM32 families).                                          */
 ...
 */
__STATIC_INLINE uint32_t
LL_ADC_IsActiveFlag_SLV1_AWD1(const ADC_Common_TypeDef *ADCxy_COMMON) {
 ...
 */
__STATIC_INLINE uint32_t
LL_ADC_IsActiveFlag_SLV2_AWD1(const ADC_Common_TypeDef *ADCxy_COMMON) {
