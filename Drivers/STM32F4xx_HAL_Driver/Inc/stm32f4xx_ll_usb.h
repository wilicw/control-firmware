...
typedef struct {
  ...
  uint32_t dma_enable; /*!< Enable or disable of the USB embedded DMA used only
                          for OTG HS.        */
  ...
  uint32_t use_dedicated_ep1; /*!< Enable or disable the use of the dedicated
                                 EP1 interrupt.              */
