...
typedef struct {
  ...
  uint32_t
      Mode; /*!< Specifies the CAN operating mode.
                 This parameter can be a value of @ref CAN_operating_mode */

  uint32_t
      SyncJumpWidth; /*!< Specifies the maximum number of time quanta the CAN
                        hardware is allowed to lengthen or shorten a bit to
                        perform resynchronization. This parameter can be a value
                        of @ref CAN_synchronisation_jump_width */
  ...
  FunctionalState
      AutoBusOff; /*!< Enable or disable the automatic bus-off management.
  ...
  FunctionalState
      ReceiveFifoLocked; /*!< Enable or disable the Receive FIFO Locked mode.
                              This parameter can be set to ENABLE or DISABLE. */

  FunctionalState TransmitFifoPriority; /*!< Enable or disable the transmit FIFO
                                           priority. This parameter can be set
...
typedef struct __CAN_HandleTypeDef {
  ...
  void (*TxMailbox0CompleteCallback)(
      struct __CAN_HandleTypeDef
          *hcan); /*!< CAN Tx Mailbox 0 complete callback    */
  void (*TxMailbox1CompleteCallback)(
      struct __CAN_HandleTypeDef
          *hcan); /*!< CAN Tx Mailbox 1 complete callback    */
  void (*TxMailbox2CompleteCallback)(
      struct __CAN_HandleTypeDef
          *hcan); /*!< CAN Tx Mailbox 2 complete callback    */
  void (*TxMailbox0AbortCallback)(
      struct __CAN_HandleTypeDef *hcan); /*!< CAN Tx Mailbox 0 abort callback */
  void (*TxMailbox1AbortCallback)(
      struct __CAN_HandleTypeDef *hcan); /*!< CAN Tx Mailbox 1 abort callback */
  void (*TxMailbox2AbortCallback)(
      struct __CAN_HandleTypeDef *hcan); /*!< CAN Tx Mailbox 2 abort callback */
  void (*RxFifo0MsgPendingCallback)(
      struct __CAN_HandleTypeDef
          *hcan); /*!< CAN Rx FIFO 0 msg pending callback    */
  void (*RxFifo0FullCallback)(
      struct __CAN_HandleTypeDef *hcan); /*!< CAN Rx FIFO 0 full callback */
  void (*RxFifo1MsgPendingCallback)(
      struct __CAN_HandleTypeDef
          *hcan); /*!< CAN Rx FIFO 1 msg pending callback    */
  void (*RxFifo1FullCallback)(
      struct __CAN_HandleTypeDef *hcan); /*!< CAN Rx FIFO 1 full callback */
  void (*SleepCallback)(
      struct __CAN_HandleTypeDef *hcan); /*!< CAN Sleep callback */
  void (*WakeUpFromRxMsgCallback)(
      struct __CAN_HandleTypeDef
          *hcan); /*!< CAN Wake Up from Rx msg callback      */
  void (*ErrorCallback)(
      struct __CAN_HandleTypeDef *hcan); /*!< CAN Error callback */

  void (*MspInitCallback)(
      struct __CAN_HandleTypeDef *hcan); /*!< CAN Msp Init callback */
  void (*MspDeInitCallback)(
      struct __CAN_HandleTypeDef *hcan); /*!< CAN Msp DeInit callback */
...
typedef enum {
  HAL_CAN_TX_MAILBOX0_COMPLETE_CB_ID =
      0x00U, /*!< CAN Tx Mailbox 0 complete callback ID         */
  HAL_CAN_TX_MAILBOX1_COMPLETE_CB_ID =
      0x01U, /*!< CAN Tx Mailbox 1 complete callback ID         */
  HAL_CAN_TX_MAILBOX2_COMPLETE_CB_ID =
      0x02U, /*!< CAN Tx Mailbox 2 complete callback ID         */
  HAL_CAN_TX_MAILBOX0_ABORT_CB_ID =
      0x03U, /*!< CAN Tx Mailbox 0 abort callback ID            */
  HAL_CAN_TX_MAILBOX1_ABORT_CB_ID =
      0x04U, /*!< CAN Tx Mailbox 1 abort callback ID            */
  HAL_CAN_TX_MAILBOX2_ABORT_CB_ID =
      0x05U, /*!< CAN Tx Mailbox 2 abort callback ID            */
  HAL_CAN_RX_FIFO0_MSG_PENDING_CB_ID =
      0x06U, /*!< CAN Rx FIFO 0 message pending callback ID     */
  HAL_CAN_RX_FIFO0_FULL_CB_ID = 0x07U, /*!< CAN Rx FIFO 0 full callback ID */
  HAL_CAN_RX_FIFO1_MSG_PENDING_CB_ID =
      0x08U, /*!< CAN Rx FIFO 1 message pending callback ID     */
  HAL_CAN_RX_FIFO1_FULL_CB_ID = 0x09U, /*!< CAN Rx FIFO 1 full callback ID */
  HAL_CAN_SLEEP_CB_ID = 0x0AU,         /*!< CAN Sleep callback ID         */
  HAL_CAN_WAKEUP_FROM_RX_MSG_CB_ID =
      0x0BU, /*!< CAN Wake Up from Rx msg callback ID          */
 ...
 */
typedef void (*pCAN_CallbackTypeDef)(
    CAN_HandleTypeDef *hcan); /*!< pointer to a CAN callback function   */
...
#define CAN_BS1_4TQ \
  ((uint32_t)(CAN_BTR_TS1_1 | CAN_BTR_TS1_0)) /*!< 4 time quantum  */
#define CAN_BS1_5TQ ((uint32_t)CAN_BTR_TS1_2) /*!< 5 time quantum  */
#define CAN_BS1_6TQ \
  ((uint32_t)(CAN_BTR_TS1_2 | CAN_BTR_TS1_0)) /*!< 6 time quantum  */
#define CAN_BS1_7TQ \
  ((uint32_t)(CAN_BTR_TS1_2 | CAN_BTR_TS1_1)) /*!< 7 time quantum  */
#define CAN_BS1_8TQ                           \
  ((uint32_t)(CAN_BTR_TS1_2 | CAN_BTR_TS1_1 | \
              CAN_BTR_TS1_0))                 /*!< 8 time quantum  */
#define CAN_BS1_9TQ ((uint32_t)CAN_BTR_TS1_3) /*!< 9 time quantum  */
#define CAN_BS1_10TQ \
  ((uint32_t)(CAN_BTR_TS1_3 | CAN_BTR_TS1_0)) /*!< 10 time quantum */
#define CAN_BS1_11TQ \
  ((uint32_t)(CAN_BTR_TS1_3 | CAN_BTR_TS1_1)) /*!< 11 time quantum */
#define CAN_BS1_12TQ                          \
  ((uint32_t)(CAN_BTR_TS1_3 | CAN_BTR_TS1_1 | \
              CAN_BTR_TS1_0)) /*!< 12 time quantum */
#define CAN_BS1_13TQ \
  ((uint32_t)(CAN_BTR_TS1_3 | CAN_BTR_TS1_2)) /*!< 13 time quantum */
#define CAN_BS1_14TQ                          \
  ((uint32_t)(CAN_BTR_TS1_3 | CAN_BTR_TS1_2 | \
              CAN_BTR_TS1_0)) /*!< 14 time quantum */
#define CAN_BS1_15TQ                          \
  ((uint32_t)(CAN_BTR_TS1_3 | CAN_BTR_TS1_2 | \
              CAN_BTR_TS1_1))                /*!< 15 time quantum */
...
#define CAN_BS2_4TQ \
  ((uint32_t)(CAN_BTR_TS2_1 | CAN_BTR_TS2_0)) /*!< 4 time quantum */
#define CAN_BS2_5TQ ((uint32_t)CAN_BTR_TS2_2) /*!< 5 time quantum */
#define CAN_BS2_6TQ \
  ((uint32_t)(CAN_BTR_TS2_2 | CAN_BTR_TS2_0)) /*!< 6 time quantum */
#define CAN_BS2_7TQ \
  ((uint32_t)(CAN_BTR_TS2_2 | CAN_BTR_TS2_1)) /*!< 7 time quantum */
...
#define CAN_FILTER_FIFO0 \
  (0x00000000U) /*!< Filter FIFO 0 assignment for filter x */
#define CAN_FILTER_FIFO1 \
  (0x00000001U) /*!< Filter FIFO 1 assignment for filter x */
/**
 * @}
 */
...
#define CAN_IT_TX_MAILBOX_EMPTY \
  ((uint32_t)CAN_IER_TMEIE) /*!< Transmit mailbox empty interrupt */

/* Receive Interrupts */
#define CAN_IT_RX_FIFO0_MSG_PENDING \
  ((uint32_t)CAN_IER_FMPIE0) /*!< FIFO 0 message pending interrupt */
#define CAN_IT_RX_FIFO0_FULL \
  ((uint32_t)CAN_IER_FFIE0) /*!< FIFO 0 full interrupt            */
#define CAN_IT_RX_FIFO0_OVERRUN \
  ((uint32_t)CAN_IER_FOVIE0) /*!< FIFO 0 overrun interrupt         */
#define CAN_IT_RX_FIFO1_MSG_PENDING \
  ((uint32_t)CAN_IER_FMPIE1) /*!< FIFO 1 message pending interrupt */
#define CAN_IT_RX_FIFO1_FULL \
  ((uint32_t)CAN_IER_FFIE1) /*!< FIFO 1 full interrupt            */
#define CAN_IT_RX_FIFO1_OVERRUN \
  ((uint32_t)CAN_IER_FOVIE1) /*!< FIFO 1 overrun interrupt         */

/* Operating Mode Interrupts */
#define CAN_IT_WAKEUP \
  ((uint32_t)CAN_IER_WKUIE) /*!< Wake-up interrupt                */
#define CAN_IT_SLEEP_ACK \
  ((uint32_t)CAN_IER_SLKIE) /*!< Sleep acknowledge interrupt      */

/* Error Interrupts */
#define CAN_IT_ERROR_WARNING \
  ((uint32_t)CAN_IER_EWGIE) /*!< Error warning interrupt          */
#define CAN_IT_ERROR_PASSIVE \
  ((uint32_t)CAN_IER_EPVIE) /*!< Error passive interrupt          */
#define CAN_IT_BUSOFF \
  ((uint32_t)CAN_IER_BOFIE) /*!< Bus-off interrupt                */
#define CAN_IT_LAST_ERROR_CODE \
  ((uint32_t)CAN_IER_LECIE) /*!< Last error code interrupt        */
#define CAN_IT_ERROR \
  ((uint32_t)CAN_IER_ERRIE) /*!< Error Interrupt                  */
/**
 * @}
 */
...
/** @addtogroup CAN_Exported_Functions_Group1 Initialization and
...
/** @addtogroup CAN_Exported_Functions_Group6 Peripheral State and Error
 * functions
