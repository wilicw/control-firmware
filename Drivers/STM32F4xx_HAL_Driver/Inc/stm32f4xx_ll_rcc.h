...
#define LL_RCC_MCO2SOURCE_PLLI2S \
  (uint32_t)(RCC_CFGR_MCO2 |     \
             (RCC_CFGR_MCO2_0 >> 16U)) /*!< PLLI2S selection as MCO2 source */
...
#define LL_RCC_MCO1_DIV_3                                                     \
  (uint32_t)(RCC_CFGR_MCO1PRE | ((RCC_CFGR_MCO1PRE_2 | RCC_CFGR_MCO1PRE_0) >> \
                                 16U)) /*!< MCO1 divided by 3 */
#define LL_RCC_MCO1_DIV_4                                                     \
  (uint32_t)(RCC_CFGR_MCO1PRE | ((RCC_CFGR_MCO1PRE_2 | RCC_CFGR_MCO1PRE_1) >> \
...
#define LL_RCC_MCO2_DIV_3                                                     \
  (uint32_t)(RCC_CFGR_MCO2PRE | ((RCC_CFGR_MCO2PRE_2 | RCC_CFGR_MCO2PRE_0) >> \
                                 16U)) /*!< MCO2 divided by 3 */
#define LL_RCC_MCO2_DIV_4                                                     \
  (uint32_t)(RCC_CFGR_MCO2PRE | ((RCC_CFGR_MCO2PRE_2 | RCC_CFGR_MCO2PRE_1) >> \
...
#define LL_RCC_PLLR_DIV_3                                                     \
  (RCC_PLLCFGR_PLLR_1 | RCC_PLLCFGR_PLLR_0) /*!< Main PLL division factor for \
                                               PLLCLK (system clock) by 3 */
#define LL_RCC_PLLR_DIV_4                                                      \
  (RCC_PLLCFGR_PLLR_2) /*!< Main PLL division factor for PLLCLK (system clock) \
                          by 4 */
#define LL_RCC_PLLR_DIV_5                                                     \
  (RCC_PLLCFGR_PLLR_2 | RCC_PLLCFGR_PLLR_0) /*!< Main PLL division factor for \
                                               PLLCLK (system clock) by 5 */
#define LL_RCC_PLLR_DIV_6                                                     \
  (RCC_PLLCFGR_PLLR_2 | RCC_PLLCFGR_PLLR_1) /*!< Main PLL division factor for \
                                               PLLCLK (system clock) by 6 */
...
#define LL_RCC_PLLQ_DIV_10 \
  (RCC_PLLCFGR_PLLQ_3 |    \
   RCC_PLLCFGR_PLLQ_1) /*!< Main PLL division factor for PLLQ output by 10 */
...
#define LL_RCC_PLLQ_DIV_12 \
  (RCC_PLLCFGR_PLLQ_3 |    \
   RCC_PLLCFGR_PLLQ_2) /*!< Main PLL division factor for PLLQ output by 12 */
...
#define LL_RCC_PLLI2SM_DIV_2                                                   \
  (RCC_PLLI2SCFGR_PLLI2SM_1) /*!< PLLI2S division factor for PLLI2SM output by \
                                2 */
#define LL_RCC_PLLI2SM_DIV_3                                                   \
  (RCC_PLLI2SCFGR_PLLI2SM_1 |                                                  \
   RCC_PLLI2SCFGR_PLLI2SM_0) /*!< PLLI2S division factor for PLLI2SM output by \
                                3 */
#define LL_RCC_PLLI2SM_DIV_4                                                   \
  (RCC_PLLI2SCFGR_PLLI2SM_2) /*!< PLLI2S division factor for PLLI2SM output by \
                                4 */
...
#define LL_RCC_PLLI2SM_DIV_8                                                   \
  (RCC_PLLI2SCFGR_PLLI2SM_3) /*!< PLLI2S division factor for PLLI2SM output by \
                                8 */
...
#define LL_RCC_PLLI2SM_DIV_16                                                  \
  (RCC_PLLI2SCFGR_PLLI2SM_4) /*!< PLLI2S division factor for PLLI2SM output by \
                                16 */
...
#define LL_RCC_PLLI2SM_DIV_32                                                  \
  (RCC_PLLI2SCFGR_PLLI2SM_5) /*!< PLLI2S division factor for PLLI2SM output by \
                                32 */
...
#define LL_RCC_PLLI2SQ_DIV_3                                                   \
  (RCC_PLLI2SCFGR_PLLI2SQ_1 |                                                  \
   RCC_PLLI2SCFGR_PLLI2SQ_0) /*!< PLLI2S division factor for PLLI2SQ output by \
                                3 */
...
#define LL_RCC_PLLI2SDIVR_DIV_1                                                \
  (RCC_DCKCFGR_PLLI2SDIVR_0) /*!< PLLI2S division factor for PLLI2SDIVR output \
                                by 1 */
#define LL_RCC_PLLI2SDIVR_DIV_2                                                \
  (RCC_DCKCFGR_PLLI2SDIVR_1) /*!< PLLI2S division factor for PLLI2SDIVR output \
                                by 2 */
...
#define LL_RCC_PLLI2SDIVR_DIV_4                                                \
  (RCC_DCKCFGR_PLLI2SDIVR_2) /*!< PLLI2S division factor for PLLI2SDIVR output \
                                by 4 */
...
#define LL_RCC_PLLI2SDIVR_DIV_8                                                \
  (RCC_DCKCFGR_PLLI2SDIVR_3) /*!< PLLI2S division factor for PLLI2SDIVR output \
                                by 8 */
...
#define LL_RCC_PLLI2SDIVR_DIV_16                                               \
  (RCC_DCKCFGR_PLLI2SDIVR_4) /*!< PLLI2S division factor for PLLI2SDIVR output \
                                by 16 */
...
#define LL_RCC_PLLI2SR_DIV_3                                                   \
  (RCC_PLLI2SCFGR_PLLI2SR_1 |                                                  \
   RCC_PLLI2SCFGR_PLLI2SR_0) /*!< PLLI2S division factor for PLLI2SR output by \
                                3 */
...
#define LL_RCC_PLLSAIM_DIV_2                                                   \
  (RCC_PLLSAICFGR_PLLSAIM_1) /*!< PLLSAI division factor for PLLSAIM output by \
                                2 */
#define LL_RCC_PLLSAIM_DIV_3                                                   \
  (RCC_PLLSAICFGR_PLLSAIM_1 |                                                  \
   RCC_PLLSAICFGR_PLLSAIM_0) /*!< PLLSAI division factor for PLLSAIM output by \
                                3 */
#define LL_RCC_PLLSAIM_DIV_4                                                   \
  (RCC_PLLSAICFGR_PLLSAIM_2) /*!< PLLSAI division factor for PLLSAIM output by \
                                4 */
...
#define LL_RCC_PLLSAIM_DIV_8                                                   \
  (RCC_PLLSAICFGR_PLLSAIM_3) /*!< PLLSAI division factor for PLLSAIM output by \
                                8 */
...
#define LL_RCC_PLLSAIM_DIV_16                                                  \
  (RCC_PLLSAICFGR_PLLSAIM_4) /*!< PLLSAI division factor for PLLSAIM output by \
                                16 */
...
#define LL_RCC_PLLSAIM_DIV_32                                                  \
  (RCC_PLLSAICFGR_PLLSAIM_5) /*!< PLLSAI division factor for PLLSAIM output by \
                                32 */
...
#define LL_RCC_PLLSAIQ_DIV_3                                                   \
  (RCC_PLLSAICFGR_PLLSAIQ_1 |                                                  \
   RCC_PLLSAICFGR_PLLSAIQ_0) /*!< PLLSAI division factor for PLLSAIQ output by \
                                3 */
...
#define LL_RCC_PLLSAIR_DIV_3                                                   \
  (RCC_PLLSAICFGR_PLLSAIR_1 |                                                  \
   RCC_PLLSAICFGR_PLLSAIR_0) /*!< PLLSAI division factor for PLLSAIR output by \
                                3 */
...
__STATIC_INLINE void LL_RCC_PLLI2S_ConfigDomain_SAI(uint32_t Source,
                                                    ...
                                                    uint32_t PLLQ_R,
                                                    uint32_t PLLDIVQ_R) {
  __IO uint32_t *pReg = (__IO uint32_t *)((uint32_t)((uint32_t)(&RCC->PLLCFGR) +
                                                     (Source & 0x80U)));
