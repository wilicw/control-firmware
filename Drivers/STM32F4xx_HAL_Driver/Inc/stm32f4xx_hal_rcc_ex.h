...
typedef struct {
  ...
  uint32_t PLLN; /*!< PLLN: Multiplication factor for PLL VCO output clock.
                      This parameter must be a number between Min_Data = 50 and
                    Max_Data = 432 except for STM32F411xE devices where the
                    Min_Data = 192 */
...
typedef struct {
  ...
  uint32_t PLLI2SQ; /*!< Specifies the division factor for SAI clock.
                         This parameter must be a number between Min_Data = 2
                       and Max_Data = 15. This parameter will be used only when
...
typedef struct {
  ...
  uint32_t PLLI2SDivQ; /*!< Specifies the PLLI2S division factor for SAI1 clock.
                          ...
                          and Max_Data = 32 This parameter will be used only
  ...
  uint32_t
      Clk48ClockSelection; /*!< Specifies CLK48 Clock Selection this clock used
                             OTG FS, SDIO and RNG clocks. This parameter can be
                             a value of @ref RCCEx_CLK48_Clock_Source */
...
typedef struct {
  ...
  uint32_t PLLSAIP; /*!< Specifies division factor for OTG FS and SDIO clocks.
                       ...
                       STM32F469xx/STM32F479xx devices. This parameter must be a
                       value of @ref RCCEx_PLLSAIP_Clock_Divider  */
...
#define IS_RCC_MCO2SOURCE(SOURCE)                                             \
  (((SOURCE) == RCC_MCO2SOURCE_SYSCLK) ||                                     \
   ((SOURCE) == RCC_MCO2SOURCE_I2SCLK) || ((SOURCE) == RCC_MCO2SOURCE_HSE) || \
