 ...
 */
    ...
    defined(USART6) || defined(UART4) || defined(UART5) || defined(UART7) || \
    defined(UART8) || defined(UART9) || defined(UART10)
...
#define __LL_USART_DIV_SAMPLING8_100(__PERIPHCLK__, __BAUDRATE__) \
  ((uint32_t)((((uint64_t)(__PERIPHCLK__)) * 25) /                \
              (2 * ((uint64_t)(__BAUDRATE__)))))
...
#endif /* USART1 || USART2 || USART3 || USART6 || UART4 || UART5 || UART7 || \
          UART8 || UART9 || UART10 */
