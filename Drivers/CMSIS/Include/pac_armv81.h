...
/**
  ...
  \details Reads the PAC key stored in the non-secure PAC_KEY_P registers when
  in secure mode. \param [out]    pPacKey  128bit PAC key
 */
...
/**
  ...
  \details writes the given PAC key to the non-secure PAC_KEY_P registers when
  in secure mode. \param [in]    pPacKey  128bit PAC key
 */
...
/**
  ...
  \details Reads the PAC key stored in the non-secure PAC_KEY_U registers when
  in secure mode. \param [out]    pPacKey  128bit PAC key
 */
...
/**
  ...
  \details writes the given PAC key to the non-secure PAC_KEY_U registers when
  in secure mode. \param [in]    pPacKey  128bit PAC key
 */
